...
<script>
    ...
    L.Control.PMButton.prototype._makeButton = function (button) {
        ...
        const newButton = L.DomUtil.create(
            ...
            'rounded-lg border transition-colors focus:outline-none focus:ring-offset-2 focus:ring-2 ' +
            'focus:ring-inset dark:focus:ring-offset-0 min-h-[2.25rem] px-2 text-sm text-gray-800 bg-white ' +
            'border-gray-300 hover:bg-gray-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 ' +
